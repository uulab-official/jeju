    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actions}>
          <HapticPressable feedback="medium" onPress={() => void openInNaverMap(place)} style={[styles.primaryButton, { backgroundColor: colors.primary }]}><Ionicons name="navigate-outline" size={20} color={colors.onPrimary} /><Text style={[styles.primaryText, { color: colors.onPrimary }]}>네이버 지도에서 보기</Text></HapticPressable>
          <HapticPressable feedback="light" onPress={() => void Share.share({ message: `${place.name}\nhttps://uulab.co.kr/places/${place.id}` })} style={[styles.secondaryButton, { borderColor: colors.border }]}><Ionicons name="share-outline" size={20} color={colors.text} /></HapticPressable>
        </View>
