...
const styles = StyleSheet.create({
  ...
  eyebrow: { ...pretendard(800), color: 'rgba(255,255,255,0.78)', fontSize: 12 },
  title: { color: '#FFFFFF', fontFamily: 'NanumOld', fontSize: 28, lineHeight: 36 },
  coverCredit: { ...pretendard(400), color: 'rgba(255,255,255,0.82)', fontSize: 12 },
  intro: { gap: 14 },
  summary: { ...pretendard(400), fontSize: 16, lineHeight: 25 },
  ...
  metaText: { ...pretendard(700), fontSize: 13 },
  sectionHeading: { gap: 4 },
  sectionTitle: { ...pretendard(900), fontSize: 21 },
  sectionCaption: { ...pretendard(400), fontSize: 12 },
  ...
  stepNumberText: { ...pretendard(900), width: 22, fontSize: 12 },
  stepImage: { width: 72, height: 78, borderRadius: 10 },
  stepCopy: { flex: 1, gap: 3 },
  stepName: { ...pretendard(800), fontSize: 16 },
  stepSummary: { ...pretendard(400), fontSize: 12, lineHeight: 17 },
  stepArea: { ...pretendard(400), fontSize: 11 },
  ...
  mapButtonTitle: { ...pretendard(800), fontSize: 14 },
  mapButtonText: { ...pretendard(400), fontSize: 11, lineHeight: 17 },
  tipCard: { borderRadius: 12, padding: 16 },
  tipCopy: { flex: 1, gap: 7 },
  tipTitle: { ...pretendard(800), fontSize: 15 },
  tipText: { ...pretendard(400), fontSize: 12, lineHeight: 19 },
  sourceCard: { borderTopWidth: StyleSheet.hairlineWidth, paddingTop: 15 },
  sourceText: { ...pretendard(400), fontSize: 11, lineHeight: 17 },
  shareButton: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center' },
  notFound: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12 },
  notFoundTitle: { ...pretendard(900), fontSize: 18 },
});
