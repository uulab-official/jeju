...
const styles = StyleSheet.create({
  screen: { flex: 1 }, headerAction: { width: layout.minTouchTarget, height: layout.minTouchTarget, alignItems: 'center', justifyContent: 'center' }, content: { padding: layout.screenPadding, paddingBottom: layout.screenBottomPadding }, summary: { borderRadius: 20, padding: layout.screenPadding, flexDirection: 'row', gap: 14, alignItems: 'center', marginBottom: 16 }, summaryIcon: { width: 52, height: 52, borderRadius: 17, alignItems: 'center', justifyContent: 'center' }, summaryCopy: { flex: 1 }, summaryTitle: { ...typography.display, fontSize: 22, lineHeight: 30, marginBottom: 4 }, summaryText: { ...typography.body, fontSize: 13, lineHeight: 19 },
